...
#Function that clicks the search button
...
#Will connect with my email
username = 'simeontester2@gmail.com'
password = 'xxxxxxxxxx'
...
def send_email(msg):
    ...
    message['From'] = 'simeontester2@gmail.com'
    message['to'] = 'simeonlico@gmail.com'

    server.sendmail('simeontester2@gmail.com', 'simeonlico@gmail.com', msg)
...
for i in range(1):    
    ...
    dep_country_chooser('Chicago')

    arrival_country_chooser('Tirane')

    dep_date_chooser('09', '09', '2019')

    return_date_chooser('09', '19', '2019')
